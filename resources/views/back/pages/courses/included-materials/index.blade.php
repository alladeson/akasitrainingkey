    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-between" style="margin: 20px 0 20px 0;">
            ...
            <div class="col-sm-3 col-md-2">
                ...
                <a href="{{ route('courses.included_materials.create') }}" class="">
                    <button type="button" class="btn btn-block btn-primary">Create Material</button>
                </a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table id="IncludedMaterialsTable" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Course</th>
...
@section('third_party_scripts')
    ...
    <script>
        ...
        let url_edit = "{{route('courses.included_materials.edit', ['id' => 'id'])}}";
        ...
        $(function() {
            ...
            datatable =  $("#IncludedMaterialsTable").DataTable({
                "responsive": true,
                "ordering": true,
                "lengthChange": false,
                "autoWidth": false,
                ...
                "ajax": {
                    "type": "POST",
                    "url": "{{route('courses.included_materials.datatable')}}",
                    data: function() {
                        return data = {
                            "course_id": course_id,
                            _token: '{{ csrf_token() }}',
                    ...
                    error: function(xhr, status, error) {
                        console.log(xhr);
                        $("#IncludedMaterialsTable").find('tbody td').html('<span class="text-danger">Failed to load data</span>');
                        // Show message error
                        Toast.fire({
                            icon: 'error',
                ...
                initComplete: function () {
                    datatable.buttons().container().appendTo('#IncludedMaterialsTable_wrapper .col-md-6:eq(0)');
                    // Delete a record
        ...
        function reloadDatatable(el) {
            ...
            course_id = $(el).val();
            // Reload datatable
            $('#IncludedMaterialsTable').DataTable().ajax.reload();
        }
    </script>
@endsection
