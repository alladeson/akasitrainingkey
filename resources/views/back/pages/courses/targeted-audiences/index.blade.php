    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-between" style="margin: 20px 0 20px 0;">
            ...
            <div class="col-sm-3 col-md-2">
                ...
                <a href="{{ route('courses.targeted_audiences.create') }}" class="">
                    <button type="button" class="btn btn-block btn-primary">Create Audience</button>
                </a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table id="targetedAudiencesTable" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Course</th>
...
@section('third_party_scripts')
    ...
    <script>
        ...
        let url_edit = "{{route('courses.targeted_audiences.edit', ['id' => 'id'])}}";
        ...
        $(function() {
            ...
            datatable =  $("#targetedAudiencesTable").DataTable({
                "responsive": true,
                "ordering": true,
                "lengthChange": false,
                "autoWidth": false,
                ...
                "ajax": {
                    "type": "POST",
                    "url": "{{route('courses.targeted_audiences.datatable')}}",
                    data: function() {
                        return data = {
                            "course_id": course_id,
                            _token: '{{ csrf_token() }}',
                    ...
                    error: function(xhr, status, error) {
                        console.log(xhr);
                        $("#targetedAudiencesTable").find('tbody td').html('<span class="text-danger">Failed to load data</span>');
                        // Show message error
                        Toast.fire({
                            icon: 'error',
                ...
                initComplete: function () {
                    datatable.buttons().container().appendTo('#targetedAudiencesTable_wrapper .col-md-6:eq(0)');
                    // Delete a record
        ...
        function reloadDatatable(el) {
            ...
            course_id = $(el).val();
            // Reload datatable
            $('#targetedAudiencesTable').DataTable().ajax.reload();
        }
    </script>
@endsection
