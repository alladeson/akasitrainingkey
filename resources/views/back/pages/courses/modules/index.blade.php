    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-between" style="margin: 20px 0 20px 0;">
            ...
            <div class="col-sm-3 col-md-2">
                ...
                <a href="{{ route('courses.modules.create') }}" class="">
                    <button type="button" class="btn btn-block btn-primary">Create Module</button>
                </a>
            </div>
        </div>
        <div class="row">
...
@section('third_party_scripts')
    ...
    <script>
        ...
        let url_edit = "{{route('courses.modules.edit', ['id' => 'id'])}}";
        ...
        $(function() {
            ...
            datatable =  $("#modulesTable").DataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "url": "{{route('courses.modules.datatable')}}",
                    data: function() {
                        return data = {
                            "course_id": course_id,
                            _token: '{{ csrf_token() }}',
                    ...
                    error: function(xhr, status, error) {
                        console.log(xhr);
                        $("#modulesTable").find('tbody td').html('<span class="text-danger">Failed to load data</span>');
                        // Show message error
                        Toast.fire({
                            icon: 'error',
                ...
                initComplete: function () {
                    datatable.buttons().container().appendTo('#modulesTable_wrapper .col-md-6:eq(0)');
                    // Delete a record
