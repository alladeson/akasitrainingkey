<div class="header-main3 border-0 header-transparent sticky-header">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9">
                    <div class="header-main-right  d-flex justify-content-end">
                        <div class="main-menu mr-30">
                            <nav id="mobile-menu">
                                <ul>
                                    <li class="menu-item-has-children"><a href="#">{{__("header-area-home.key_Trainings") }}</a>
                                        <ul class="sub-menu">
                                            <li><a href="{{route('courses.catalog')}}">{{__("header-area-home.key_Catalogue") }}</a>
                                            </li>
                                            <li><a href="{{route('courses.catalog')}}">{{__("header-area-home.key_Certifications") }}</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="{{route('trainings.schedule')}}">{{__("header-area-home.key_Schedule") }}</a></li>
                                    <li class="menu-item-has-children"><a href="#">{{__("header-area-home.key_Resources") }}</a>
                                        <ul class="sub-menu">
                                            <li><a href="{{route('faq')}}">{{__("header-area-home.key_FAQ") }}</a></li>
                                            <li><a href="{{route('location')}}">{{__("header-area-home.key_Locations") }}</a></li>
                                            {{-- <li><a href="#">{{__("header-area-home.key_Release") }}</a></li> --}}
                                            <li><a href="{{route('courses.catalog.webinars')}}">{{__("header-area-home.key_Webinars") }}</a></li>
                                            <li><a href="#">{{__("header-area-home.key_Certified") }}</a></li>
                                            <li><a href="{{route('testimonies')}}">{{__("header-area-home.key_Testimonies") }}</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="https://akasigroup.net/" target="_blank">{{__("header-area-home.key_Consulting") }}</a></li>
                                    <li><a href="{{route('contact')}}">{{__("header-area-home.key_Contact") }}</a></li>
                                </ul>
                            </nav>
                        </div>
                                ...
                                <div class="cart-wrapper">
                                    @auth
                                        <a href="{{ Auth::user()->hasRole(['Admin', 'Commercial']) ? route('dashboard') : url('/profile') }}" class="header-2 border-0 p-0">
                                            <div class="header__cart-icon p-relative">
                                                <svg width="32" height="32" viewBox="0 0 56 56" fill="#fff" xmlns="http://www.w3.org/2000/svg">
