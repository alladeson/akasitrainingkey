                                                ...
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <p class=""
                                                            ...
                                                            align="left">{{$mailData['user']->name}} shared with you the link to the following training:
                                                            <strong>{{$mailData['course']->name_en}}</strong>.
                                                        </p>
                                                        <p class=""
                                                            style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                            align="left">You can view the details of this course on our website.
                                                        </p>
                                                        <table class="s-4 w-full" role="presentation" border="0"
                                                            cellpadding="0" cellspacing="0" style="width: 100%;"
                                                            width="100%">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 192px; margin: 0;"
                                                                        ...
                                                                        width="192">
                                                                        <a href="{{ route('course', ['url_tag' => $mailData['course']->url_tag]) }}"
                                                                            style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #dc3545; padding: 8px 24px; border: 1px solid #dc3545;">
                                                                            View Training Details</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
