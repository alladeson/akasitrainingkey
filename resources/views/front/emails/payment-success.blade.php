                                                ...
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <div class="space-y-4">
                                                        <h6 class="text-4xl"
                                                            ...
                                                            align="left">Hello {{ $mailData['profile']->first_name }}!</h6>
                                                        ...
                                                        <p class=""
                                                            ...
                                                            align="left">Thank you for finalizing your reservation.
                                                            Track your payment history on the Akasi Learning Key
                                                            website.</p>
                                                        <table class="s-4 w-full" role="presentation" border="0"
                                                            cellpadding="0" cellspacing="0" style="width: 100%;"
                                                            width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class="text-center text-muted"
                                                                        ...
                                                                        #{{ $mailData['orders'][0]->translation_id }}
                                                                    </p>
