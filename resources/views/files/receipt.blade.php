                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            ...
                            <div class="">
                                ...
                                <p class="" style="margin: 5px 0 0 0;">
                                    <span style="display: inline-flex; width: 130px;">Receipt number</span>
                                    <span style="display: inline-flex; width: 260px;">{{$receipt_number}}</span>
                                </p>
                                <p class="" style="margin: 5px 0 0 0;">
                                    <span style="display: inline-flex; width: 130px;">Date paid</span>
                                    <span style="display: inline-flex; width: 260px;">{{$date}}</span>
                                </p>
                                <p class="" style="margin: 5px 0 0 0;">
                                    <span style="display: inline-flex; width: 130px;">Payment method</span>
                                    <span style="display: inline-flex; width: 260px;">{{$payment_method}}</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="py-2" style="padding: 0px 0 0px 0;">
                            <h3 class="font-size-15" style="font-size: 24px; margin: 5px 0px;">{{ $total_amount }} paid on {{$date}}</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-centered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row" colspan="3" class="border-0 text-end">Amount paid :</th>
